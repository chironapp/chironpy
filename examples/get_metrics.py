...
example1 = os.path.join(
    "chironpy", "examples", "data", "18360138543_ACTIVITY_Osaka_Marathon_2025.fit"
)
...
example2 = os.path.join(
    "chironpy",
    "examples",
    "data",
    "74d893f7-1349-4b2c-ac5f-60246396b8b1_local_strava_Osaka_Marathon_2025.json",
)
